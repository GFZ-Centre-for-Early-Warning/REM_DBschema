...
--
-- Name: ttime_equal(character varying, timestamp without time zone); Type: FUNCTION; Schema: history; Owner: postgres
--

CREATE FUNCTION ttime_equal(tbl character varying, ttime timestamp without time zone) RETURNS SETOF record
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION history.ttime_equal(tbl character varying, ttime timestamp without time zone) OWNER TO postgres;

--
-- Name: FUNCTION ttime_equal(tbl character varying, ttime timestamp without time zone); Type: COMMENT; Schema: history; Owner: postgres
--

COMMENT ON FUNCTION ttime_equal(tbl character varying, ttime timestamp without time zone) IS '
...
--
-- Name: ttime_equal(character varying, character varying, timestamp without time zone); Type: FUNCTION; Schema: history; Owner: postgres
--

CREATE FUNCTION ttime_equal(tbl_in character varying, tbl_out character varying, ttime timestamp without time zone) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE 
  tbl_struct text;
...
ALTER FUNCTION history.ttime_equal(tbl_in character varying, tbl_out character varying, ttime timestamp without time zone) OWNER TO postgres;

--
-- Name: FUNCTION ttime_equal(tbl_in character varying, tbl_out character varying, ttime timestamp without time zone); Type: COMMENT; Schema: history; Owner: postgres
--

COMMENT ON FUNCTION ttime_equal(tbl_in character varying, tbl_out character varying, ttime timestamp without time zone) IS '
This function searches history.logged_actions to get the latest version of each object primitive whose transaction time equals the queried timestamp. 
...
--
-- Name: ttime_inside(character varying, timestamp without time zone, timestamp without time zone); Type: FUNCTION; Schema: history; Owner: postgres
--

CREATE FUNCTION ttime_inside(tbl character varying, ttime_from timestamp without time zone DEFAULT '0001-01-01 00:00:00'::timestamp without time zone, ttime_to timestamp without time zone DEFAULT now()) RETURNS SETOF record
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY EXECUTE '
...
ALTER FUNCTION history.ttime_inside(tbl character varying, ttime_from timestamp without time zone, ttime_to timestamp without time zone) OWNER TO postgres;

--
-- Name: FUNCTION ttime_inside(tbl character varying, ttime_from timestamp without time zone, ttime_to timestamp without time zone); Type: COMMENT; Schema: history; Owner: postgres
--

COMMENT ON FUNCTION ttime_inside(tbl character varying, ttime_from timestamp without time zone, ttime_to timestamp without time zone) IS '
...
--
-- Name: ttime_inside(character varying, character varying, timestamp without time zone, timestamp without time zone); Type: FUNCTION; Schema: history; Owner: postgres
--

CREATE FUNCTION ttime_inside(tbl_in character varying, tbl_out character varying, ttime_from timestamp without time zone, ttime_to timestamp without time zone) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE 
  tbl_struct text;
...
ALTER FUNCTION history.ttime_inside(tbl_in character varying, tbl_out character varying, ttime_from timestamp without time zone, ttime_to timestamp without time zone) OWNER TO postgres;

--
-- Name: FUNCTION ttime_inside(tbl_in character varying, tbl_out character varying, ttime_from timestamp without time zone, ttime_to timestamp without time zone); Type: COMMENT; Schema: history; Owner: postgres
--

COMMENT ON FUNCTION ttime_inside(tbl_in character varying, tbl_out character varying, ttime_from timestamp without time zone, ttime_to timestamp without time zone) IS '
This function searches history.logged_actions to get the latest version of each object primitive that has been modified only within the queried transaction time.
Results table structure is defined dynamically from input table/view. Returns view.
Arguments:
   tbl_in:		schema.table character varying
...
--
-- Name: vtime_equal(character varying, character varying, character varying, text, text); Type: FUNCTION; Schema: history; Owner: postgres
--

CREATE FUNCTION vtime_equal(tbl character varying, col_value character varying, col_vtime character varying, vtime_from text DEFAULT '0001-01-01 00:00:00'::text, vtime_to text DEFAULT now()) RETURNS SETOF record
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY EXECUTE '
...
ALTER FUNCTION history.vtime_equal(tbl character varying, col_value character varying, col_vtime character varying, vtime_from text, vtime_to text) OWNER TO postgres;

--
-- Name: FUNCTION vtime_equal(tbl character varying, col_value character varying, col_vtime character varying, vtime_from text, vtime_to text); Type: COMMENT; Schema: history; Owner: postgres
--

COMMENT ON FUNCTION vtime_equal(tbl character varying, col_value character varying, col_vtime character varying, vtime_from text, vtime_to text) IS '
...
--
-- Name: vtime_equal(character varying, character varying, character varying, character varying, text, text); Type: FUNCTION; Schema: history; Owner: postgres
--

CREATE FUNCTION vtime_equal(tbl_in character varying, tbl_out character varying, col_value character varying, col_vtime character varying, vtime_from text DEFAULT '0001-01-01 00:00:00'::text, vtime_to text DEFAULT now()) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE 
  tbl_struct text;
...
ALTER FUNCTION history.vtime_equal(tbl_in character varying, tbl_out character varying, col_value character varying, col_vtime character varying, vtime_from text, vtime_to text) OWNER TO postgres;

--
-- Name: FUNCTION vtime_equal(tbl_in character varying, tbl_out character varying, col_value character varying, col_vtime character varying, vtime_from text, vtime_to text); Type: COMMENT; Schema: history; Owner: postgres
--

COMMENT ON FUNCTION vtime_equal(tbl_in character varying, tbl_out character varying, col_value character varying, col_vtime character varying, vtime_from text, vtime_to text) IS '
This function searches history.logged_actions to get the latest version of each object primitive whose valid time range equals the queried timerange.
Results table structure is defined dynamically from input table/view. Returns view.
Arguments:
   tbl_in:		schema.table character varying
...
--
-- Name: vtime_inside(character varying, character varying, character varying, text, text); Type: FUNCTION; Schema: history; Owner: postgres
--

CREATE FUNCTION vtime_inside(tbl character varying, col_value character varying, col_vtime character varying, vtime_from text DEFAULT '0001-01-01 00:00:00'::text, vtime_to text DEFAULT now()) RETURNS SETOF record
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY EXECUTE '
...
ALTER FUNCTION history.vtime_inside(tbl character varying, col_value character varying, col_vtime character varying, vtime_from text, vtime_to text) OWNER TO postgres;

--
-- Name: FUNCTION vtime_inside(tbl character varying, col_value character varying, col_vtime character varying, vtime_from text, vtime_to text); Type: COMMENT; Schema: history; Owner: postgres
--

COMMENT ON FUNCTION vtime_inside(tbl character varying, col_value character varying, col_vtime character varying, vtime_from text, vtime_to text) IS '
...
--
-- Name: vtime_inside(character varying, character varying, character varying, character varying, text, text); Type: FUNCTION; Schema: history; Owner: postgres
--

CREATE FUNCTION vtime_inside(tbl_in character varying, tbl_out character varying, col_value character varying, col_vtime character varying, vtime_from text DEFAULT '0001-01-01 00:00:00'::text, vtime_to text DEFAULT now()) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE 
  tbl_struct text;
...
ALTER FUNCTION history.vtime_inside(tbl_in character varying, tbl_out character varying, col_value character varying, col_vtime character varying, vtime_from text, vtime_to text) OWNER TO postgres;

--
-- Name: FUNCTION vtime_inside(tbl_in character varying, tbl_out character varying, col_value character varying, col_vtime character varying, vtime_from text, vtime_to text); Type: COMMENT; Schema: history; Owner: postgres
--

COMMENT ON FUNCTION vtime_inside(tbl_in character varying, tbl_out character varying, col_value character varying, col_vtime character varying, vtime_from text, vtime_to text) IS '
This function searches history.logged_actions to get the latest version of each object primitive whose valid time is completely inside the queried timerange.
Results table structure is defined dynamically from input table/view. Returns view.
Arguments:
   tbl_in:		schema.table character varying
...
--
-- Name: vtime_intersect(character varying, character varying, character varying, text, text); Type: FUNCTION; Schema: history; Owner: postgres
--

CREATE FUNCTION vtime_intersect(tbl character varying, col_value character varying, col_vtime character varying, vtime_from text DEFAULT '0001-01-01 00:00:00'::text, vtime_to text DEFAULT now()) RETURNS SETOF record
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN QUERY EXECUTE '
...
ALTER FUNCTION history.vtime_intersect(tbl character varying, col_value character varying, col_vtime character varying, vtime_from text, vtime_to text) OWNER TO postgres;

--
-- Name: FUNCTION vtime_intersect(tbl character varying, col_value character varying, col_vtime character varying, vtime_from text, vtime_to text); Type: COMMENT; Schema: history; Owner: postgres
--

COMMENT ON FUNCTION vtime_intersect(tbl character varying, col_value character varying, col_vtime character varying, vtime_from text, vtime_to text) IS '
...
--
-- Name: vtime_intersect(character varying, character varying, character varying, character varying, text, text); Type: FUNCTION; Schema: history; Owner: postgres
--

CREATE FUNCTION vtime_intersect(tbl_in character varying, tbl_out character varying, col_value character varying, col_vtime character varying, vtime_from text DEFAULT '0001-01-01 00:00:00'::text, vtime_to text DEFAULT now()) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE 
  tbl_struct text;
...
ALTER FUNCTION history.vtime_intersect(tbl_in character varying, tbl_out character varying, col_value character varying, col_vtime character varying, vtime_from text, vtime_to text) OWNER TO postgres;

--
-- Name: FUNCTION vtime_intersect(tbl_in character varying, tbl_out character varying, col_value character varying, col_vtime character varying, vtime_from text, vtime_to text); Type: COMMENT; Schema: history; Owner: postgres
--

COMMENT ON FUNCTION vtime_intersect(tbl_in character varying, tbl_out character varying, col_value character varying, col_vtime character varying, vtime_from text, vtime_to text) IS '
This function searches history.logged_actions to get the latest version of each object primitive whose valid time intersects with the queried timerange.
Results table structure is defined dynamically from input table/view. Returns view.
Arguments:
   tbl_in:		schema.table character varying
